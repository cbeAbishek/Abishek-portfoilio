      ...
      >
        <div>
          ...
          <div className="text-[30px] md:text-[35px] flex justify-center gap-5 items-center md:mt-10 mt-8 md:gap-12 cursor-pointer mb-20 ">
            ...
            <Link target="_blank" to="https://github.com/cbeAbishek" className="group relative">
            ...
            <Link target="_blank" to="https://www.instagram.com/smakabhishek" className="group relative">
            ...
            <Link target="_blank" to="https://discord.gg/x5YGmHKN" className="group relative">
            ...
            <Link
              target="_blank"
              to="https://www.instagram.com/smakabhishek" className="group relative"
            >
            ...
            <Link
              target="_blank"
              to="https://www.threads.net/@smakabhishek" className="group relative"
            >
